...
public class Main extends Agent {
	...
	public class CriandoAgentes extends OneShotBehaviour{
		...
		public void action() {
			try {
				AgentController correlacao = metodos.createNewAgent("correlacao", "metodosMatematicos.CorrelacaoAgente", null);
				correlacao.start();
				...
				AgentController consultor =metodos.createNewAgent("consultor", "metodosMatematicos.ConsultorAgente", null);
				consultor.start();
