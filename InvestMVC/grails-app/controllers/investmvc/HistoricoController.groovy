...
class HistoricoController {
    ...
    def save(Historico historicoInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.created.message', args: [message(code: 'historicoInstance.label', default: 'Historico'), historicoInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'historicoInstance.label', default: 'Historico'), params.id])
                redirect action: "index", method: "GET"
            }
