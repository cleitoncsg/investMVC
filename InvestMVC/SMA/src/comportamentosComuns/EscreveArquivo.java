...
public abstract class EscreveArquivo {
	...
	public static void escreveDecisao(String decisao, double alavanca)
		...
		RodarComandos.rodarComandoNoTerminal("escreveDecisaoFinal " + decisao
				+ " " + alavanca + " " + Controlador.fibonacciResposta + " "
				+ Controlador.minimoQuadradosSaida + " "
				+ LeituraArquivo.lerResistencia());
		/**
		 * FileWriter arquivo = new
		 * FileWriter("../../MQL4/Files/decisaoFinal.txt");
		 * 
		 * System.out.println("-----------------------------------------");
		 ...
		 * 
		 * 
		 * arquivo.write(decisao); arquivo.append("\n");
		 * arquivo.append(String.valueOf(alavanca)); arquivo.append("\n");
