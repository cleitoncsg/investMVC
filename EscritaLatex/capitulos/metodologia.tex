...
\textbf{Sprint} & \textbf{Atividades} & \textbf{Data de início} & \textbf{Data de finalização} \\ \hline
\endhead
\hline \multicolumn{4}{c}{\textit{Continuaçao na próxima página}} \\
\endfoot
\hline
\endlastfoot
...
Esta seção descreve o planejamento para seleção dos métodos matemáticos para operar de forma automatizada no mercado de moedas. O planejamento da seleção é uma adaptação do protocolo presente no Anexo B \cite{brereton}.
