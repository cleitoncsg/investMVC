...
Na Figura \ref{componente} é possível perceber que os módulos interagem entre si, essa interação fica mais evidente no diagrama de sequência do sistema, figura \ref{sequencia}.
