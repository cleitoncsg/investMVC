...
Este capítulo irá apresentar os resultados obtidos com a execução deste trabalho. Para tanto, optou-se mostrá-los considerando os objetivos mostrados na Seção\ref{sec:objetivos}. Observe, portanto , que cada uma das seções deste capítulo corresponde a um objetivo específico definido para esta pesquisa. Para alcançar os resultados, foi necessário utilizar ferramentas de auxílio, elas encontram-se no Apêndice \ref{ap:suporte}.
