...
\caption{Gráfico gerado pela simulação do expert CorrelacaoPearson.mql no período de Agosto de 2012 a Agosto de 2013}
...
\caption{Gráfico gerado pela simulação do expert CorrelacaoPearson.mql no período de Agosto de 2013 a Agosto de 2014}
...
\caption{Gráfico gerado pela simulação do expert Fibonacci.mql no período de Agosto de 2012 a Agosto de 2013}
\label{protocoloFib3}
\end{figure}
...
\caption{Gráfico gerado pela simulação do expert Fibonacci.mql no período de Agosto de 2013 a Agosto de 2014}
\label{protocoloFib4}
\end{figure}
