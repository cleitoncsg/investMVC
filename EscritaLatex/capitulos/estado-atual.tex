...
A Tabela \ref{resultadoMetodos} evidencia os resultados financeiros de cada Método Matemático em percentual de negociações com lucro. Isso acaba reforçando o motivo da escolha dos métodos Correlação Linear, Fibonacci e Mínimos Quadrados.
